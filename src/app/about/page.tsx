...
export default function AboutPage() {
  return (
    <div className="mt-16 flex flex-col gap-4 py-8">
      ...
      <Paragraph text="No meu papel no Squad Mateus Serviços Financeiros, sou responsável pela integração com serviços financeiros externos, ampliando as opções de pagamento nas lojas. Participei ativamente do projeto de Integração com serviços de instituições financeiras parceiras, atuando como arquiteto do protótipo, desenvolvedor back-end e DevOps. Utilizei tecnologias como Node.js, Typescript, Docker e Kafka." />
