...
export function Navbar() {
  return (
    <Collapsible.Root className="fixed left-0 right-0 top-0 z-20 flex flex-col lg:relative lg:flex-row lg:place-content-between lg:items-center">
      <div className="dark:shadow-port-black-700 dark:bg-port-black-700 flex w-full place-content-between items-center bg-zinc-50 p-4 shadow-lg lg:px-0 lg:shadow-transparent">
        <Logo />
      ...
      >
        <ul className="dark:bg-port-black-700 flex h-screen flex-col items-center bg-zinc-50 lg:h-auto lg:flex-row lg:space-x-12">
